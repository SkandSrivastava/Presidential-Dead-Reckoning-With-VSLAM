...
% Read log_file
disp('1) Load real data with foot-mounted test and inspect');
...
disp('-> TO DO: Check uncorrect INS integration/ remove bias (press enter to continue)');
pause;
...
disp('INS-ZUPT ended. Showing results...');
disp('-> TO DO: Check correct integration INS-ZUPT');
