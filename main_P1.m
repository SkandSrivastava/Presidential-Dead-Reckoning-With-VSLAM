...
% Read log_file
disp('1) Load ideal noise-free data (ideal_footIMU_rectangulo.txt) and inspect');
...
disp('Logfile Read...');
disp('-> TO DO: Inspect IMU signals  (press enter to continue)');
pause;
...
% Apply INS to obtain Pos,Vel y Att:
disp('Applying INS with noise...');
[Pos_G_rec,Vel_G_rec,Att_G_rec]=INS(Acc,Gyr);
disp('INS with noise ended. Showing results...');
